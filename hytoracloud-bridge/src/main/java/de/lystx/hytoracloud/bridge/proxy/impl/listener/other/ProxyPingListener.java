...
import de.lystx.hytoracloud.bridge.proxy.events.other.ProxyServerMotdRequestEvent;
...
public class ProxyPingListener implements Listener {
    ...
    public void onProxyPing(ProxyPingEvent event) {
        try {
            ...
            if (uniqueId != null) {
                ...
                ProxyServerMotdRequestEvent proxyServerMotdRequestEvent = ProxyServer.getInstance().getPluginManager().callEvent(new ProxyServerMotdRequestEvent(playerConnection));
    ...
    public String replace(String string, int port) {
        ...
        return string
                ...
                .replace("%maintenance%", String.valueOf(CloudDriver.getInstance().getNetworkConfig().getNetworkConfig().isMaintenance()));
    }
}
