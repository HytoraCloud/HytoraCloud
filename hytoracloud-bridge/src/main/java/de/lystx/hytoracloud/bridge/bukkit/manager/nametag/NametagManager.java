package de.lystx.hytoracloud.bridge.bukkit.manager.nametag;
...
public class NametagManager {
    ...
    public void setNametag(String prefix, String suffix, Integer priority, String user, List<Player> players) {
        ...
        try {
            ...
            Constructor<?> constructor = de.lystx.hytoracloud.driver.service.util.reflection.Reflections.getNMSClass("PacketPlayOutScoreboardTeam").getConstructor();
            Object packet = constructor.newInstance();
            List<String> contents = new ArrayList<>();
            contents.add(Bukkit.getPlayer(user).getName());
            try {
                de.lystx.hytoracloud.driver.service.util.reflection.Reflections.setField(packet, "a", team_name);
                de.lystx.hytoracloud.driver.service.util.reflection.Reflections.setField(packet, "b", team_name);
                de.lystx.hytoracloud.driver.service.util.reflection.Reflections.setField(packet, "c", prefix);
                de.lystx.hytoracloud.driver.service.util.reflection.Reflections.setField(packet, "d", suffix);
                de.lystx.hytoracloud.driver.service.util.reflection.Reflections.setField(packet, "e", "ALWAYS");
                de.lystx.hytoracloud.driver.service.util.reflection.Reflections.setField(packet, "h", 0);
                de.lystx.hytoracloud.driver.service.util.reflection.Reflections.setField(packet, "g", contents);
            } catch (Exception ex) {
                de.lystx.hytoracloud.driver.service.util.reflection.Reflections.setField(packet, "a", team_name);
                de.lystx.hytoracloud.driver.service.util.reflection.Reflections.setField(packet, "b", team_name);
                de.lystx.hytoracloud.driver.service.util.reflection.Reflections.setField(packet, "c", prefix);
                de.lystx.hytoracloud.driver.service.util.reflection.Reflections.setField(packet, "d", suffix);
                de.lystx.hytoracloud.driver.service.util.reflection.Reflections.setField(packet, "e", "ALWAYS");
                de.lystx.hytoracloud.driver.service.util.reflection.Reflections.setField(packet, "i", 0);
                de.lystx.hytoracloud.driver.service.util.reflection.Reflections.setField(packet, "h", contents);
            }
            if (players == null) {
    ...
    private void clearTabStyle(Player user, Integer priority, List<Player> players) {
        try {
            ...
            try {
                ...
                de.lystx.hytoracloud.driver.service.util.reflection.Reflections.setField(packet, "b", team_name);
                de.lystx.hytoracloud.driver.service.util.reflection.Reflections.setField(packet, "e", "ALWAYS");
                de.lystx.hytoracloud.driver.service.util.reflection.Reflections.setField(packet, "h", 1);
                de.lystx.hytoracloud.driver.service.util.reflection.Reflections.setField(packet, "g", contents);
            } catch (Exception ex) {
                de.lystx.hytoracloud.driver.service.util.reflection.Reflections.setField(packet, "a", team_name);
                de.lystx.hytoracloud.driver.service.util.reflection.Reflections.setField(packet, "b", team_name);
                de.lystx.hytoracloud.driver.service.util.reflection.Reflections.setField(packet, "e", "ALWAYS");
                de.lystx.hytoracloud.driver.service.util.reflection.Reflections.setField(packet, "i", 1);
                de.lystx.hytoracloud.driver.service.util.reflection.Reflections.setField(packet, "h", contents);
            }
            if (players == null) {
                Bukkit.getOnlinePlayers().forEach(t -> this.sendPacket(t, packet));
