...
public class ServiceObject extends WrappedObject<IService, ServiceObject> implements IService {
    ...
    public String getName() {
        return this.getGroup().getName() + "-" + this.id;
    }
    ...
    public String getMotd() {
        ...
        if (getGroup().getEnvironment().equals(ServerEnvironment.PROXY)) {
    ...
    public DriverQuery<String> getTPS() {
        if (this.getGroup().getEnvironment() == ServerEnvironment.PROXY) {
    ...
    public Optional<IServiceGroup> getSyncedGroup() {
        return CloudDriver.getInstance().getServiceManager().getCachedGroups().stream().filter(iServiceGroup -> iServiceGroup.getName().equalsIgnoreCase(this.getGroup().getName())).findFirst();
    }
