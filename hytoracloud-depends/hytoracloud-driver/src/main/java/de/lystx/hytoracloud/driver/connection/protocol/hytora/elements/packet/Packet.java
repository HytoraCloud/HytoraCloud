...
import de.lystx.hytoracloud.driver.connection.protocol.hytora.elements.packet.response.PacketRespond;
...
public abstract class Packet {
    ...
    public void toReply(INetworkConnection connection, Consumer<Component> consumer) {
     ...
     * @return component
     */
    public Component toReply(INetworkConnection connection) {
     ...
     * And if the {@link com.sun.xml.internal.ws.api.message.Packet} responded it will return its
     * to work with it
     *
     * @return the Response the Packet gets
     */
    public Component toReply(INetworkConnection connection, int timeOut) {
