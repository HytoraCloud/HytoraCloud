...
import de.lystx.hytoracloud.driver.connection.protocol.hytora.elements.other.TimedHashMap;
...
public class ServerCatcher {
     ...
     */
    private final List<Consumer<NetworkBridge>> connectionHandlers;
     ...
     */
    public void handleComponent(Component hytoraComponent, NetworkBridge client) {
