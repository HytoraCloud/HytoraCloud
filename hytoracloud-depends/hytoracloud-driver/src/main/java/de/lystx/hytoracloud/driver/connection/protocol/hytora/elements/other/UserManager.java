...
public class UserManager {
     ...
     */
    private final INetworkConnection INetworkConnection;

    public UserManager(INetworkConnection INetworkConnection) {
        this.connectedUsers = new HashMap<>();
        this.INetworkConnection = INetworkConnection;
    }
    ...
    public void unregisterUser(NetworkBridge bridge) {
        ...
        if (this.INetworkConnection instanceof NetworkServer) {

            NetworkServer hytoraServer = (NetworkServer) INetworkConnection;
