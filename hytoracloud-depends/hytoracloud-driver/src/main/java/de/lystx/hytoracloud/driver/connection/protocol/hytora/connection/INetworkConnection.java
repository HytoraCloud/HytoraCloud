package de.lystx.hytoracloud.driver.connection.protocol.hytora.connection;
...
public interface INetworkConnection extends IProtocolSender, Closeable {
     ...
     *
      * @return the future
     */
    Future<INetworkConnection> createConnection();
