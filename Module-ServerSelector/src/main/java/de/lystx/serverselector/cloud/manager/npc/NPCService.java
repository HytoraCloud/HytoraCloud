...
public class NPCService extends CloudService {
    ...
    public NPCService(CloudLibrary cloudLibrary, String name, CloudServiceType cloudType) {
        ...
        this.npcDirectory = new File(fs.getDatabaseDirectory(), "npcSelector/"); this.npcDirectory.mkdirs();
    ...
    public void load() {
        try {
            this.document = new VsonObject(npcFile, VsonSettings.OVERRITE_VALUES, VsonSettings.CREATE_FILE_IF_NOT_EXIST);
            this.config = new VsonObject(npcLayout, VsonSettings.OVERRITE_VALUES, VsonSettings.CREATE_FILE_IF_NOT_EXIST);
