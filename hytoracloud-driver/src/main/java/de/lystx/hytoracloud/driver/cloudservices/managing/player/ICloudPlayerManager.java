...
public interface ICloudPlayerManager extends Iterable<CloudPlayer> {
    ...
    /**
     * Lists all {@link CloudPlayer}s on a given {@link IService}
     *
     * @param IService the service
     * @return list of players on this service
     */
    List<CloudPlayer> getPlayersOnServer(IService IService);

    /**
     * Lists all {@link CloudPlayer}s on a given {@link IServiceGroup}
     *
     * @param IServiceGroup the group
     * @return list of players on this service
     */
    List<CloudPlayer> getPlayersOnGroup(IServiceGroup IServiceGroup);
