package de.lystx.hytoracloud.driver.connection.protocol.netty.global.packet.codec;
...
public class PacketDecoder extends ByteToMessageDecoder {
    ...
    public PacketDecoder(INetworkConnection connection) {
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf buf, List<Object> output) {
        try {
            ...
            if (buf.readableBytes() == 0) {
                throw new CloudDriverException("No readable bytes inside packet!");
            }
            ...
            if (this.protocolVersion != protocolVersion) {
                ...
                throw new CloudDriverException("Received packets with wrong protocol version! " + protocolVersion + " instead of " + this.protocolVersion);
            }
            ...
            packet.setChannel(new NetworkChannelObject(this.connection, ctx.channel()));
            packet.setBuf(buf);
