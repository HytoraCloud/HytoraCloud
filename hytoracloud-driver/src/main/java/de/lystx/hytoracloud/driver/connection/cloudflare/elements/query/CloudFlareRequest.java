...
public class CloudFlareRequest<T> {
    ...
    public CloudFlareResponse<T> asObject() {
        ...
        if (json.get("result").isJsonObject() ) {
            return new CloudFlareResponse<>(json, JsonDocument.GSON.fromJson(json.getAsJsonObject("result"), typeClass), httpResponse.isSuccessful(), httpResponse.getStatus(), httpResponse.getMessage());
    ...
    public CloudFlareResponse<T> singleTonOrList() {
        ...
        if (json.get("result").isJsonArray() ) {
            ...
            object = JsonDocument.GSON.fromJson(json.getAsJsonObject("result"), typeClass);
        else object = null;
    ...
    public static  <T> List<T> toListOfObjects(JsonArray jsonArray, Class<T> objectType) {
        return JsonDocument.GSON.fromJson(jsonArray, new ParameterizedType() {
            @Override
