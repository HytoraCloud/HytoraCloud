package de.lystx.hytoracloud.driver.service.cloud.server;
...
public interface IServiceManager {
     ...
     */
    void startService(ServiceGroup serviceGroup, Service service, PropertyObject properties);

    /**
     * Starts a {@link Service} from a {@link ServiceGroup} with no properties as {@link PropertyObject}
     *
     * @param serviceGroup the group
     * @param service the service
     */
    ...
    /**
     * Starts a random {@link Service} from a {@link ServiceGroup} with properties as {@link PropertyObject}
     *
     * @param serviceGroup the group
     * @param properties the properties
     */
    void startService(ServiceGroup serviceGroup, PropertyObject properties);
    ...
    void setCachedServices(Map<ServiceGroup, List<Service>> cachedServices);
     ...
     * @return map cache
     */
    Map<ServiceGroup, List<Service>> getCachedServices();
