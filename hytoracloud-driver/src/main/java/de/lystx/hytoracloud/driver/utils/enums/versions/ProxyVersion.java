package de.lystx.hytoracloud.driver.utils.enums.versions;
...
public enum ProxyVersion {
    ...
    VELOCITY("https://versions.velocitypowered.com/download/3.0.0.jar", "proxy.jar", 2, "velocity", "com.velocitypowered.api.proxy.ProxyServer"),
