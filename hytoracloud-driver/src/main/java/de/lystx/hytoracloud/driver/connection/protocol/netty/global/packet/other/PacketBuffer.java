package de.lystx.hytoracloud.driver.connection.protocol.netty.global.packet.other;
...
public class PacketBuffer {
    ...
    public PacketBuffer writeCustom(Object obj) {
        this.writeString(obj.getClass().getName());
        this.writeString(JsonDocument.toString(obj));
        return this;
    }

    @SneakyThrows
    public <T> T readCustom(Class<? extends T> wrapperClass) {
        String clazz = readString();
        String json = readString();
        return JsonDocument.GSON.fromJson(json, wrapperClass);
    }
