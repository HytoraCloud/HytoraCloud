...
public enum ProxyVersion {
    ...
    BUNGEECORD("https://ci.md-5.net/job/BungeeCord/lastSuccessfulBuild/artifact/bootstrap/target/BungeeCord.jar", "proxy.jar", 1, "bungeecord"),
    VELOCITY("https://versions.velocitypowered.com/download/1.1.8.jar", "proxy.jar", 2, "velocity"),
    WATERFALL("https://papermc.io/api/v2/projects/waterfall/versions/1.16/builds/401/downloads/waterfall-1.16-401.jar", "proxy.jar", 3, "waterfall");
