...
import de.lystx.hytoracloud.driver.connection.http.mapper.impl.JsonMapper;
import de.lystx.hytoracloud.driver.connection.http.mapper.impl.TextPlainMapper;
