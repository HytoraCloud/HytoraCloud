...
import de.lystx.hytoracloud.driver.connection.http.withbody.HttpDeleteWithBody;
import de.lystx.hytoracloud.driver.connection.http.withbody.HttpOptionsWithBody;
import de.lystx.hytoracloud.driver.connection.http.withbody.HttpPatchWithBody;
