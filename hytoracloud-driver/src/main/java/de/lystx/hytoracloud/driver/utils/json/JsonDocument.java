...
@Getter @Setter
public class JsonDocument implements de.lystx.hytoracloud.driver.utils.json.JsonObject<JsonDocument> {
    ...
    @Override
    public de.lystx.hytoracloud.driver.utils.json.JsonObject<JsonDocument> append(String key, Object value) {
        try {
            if (value == null) {
                return this;
            }
    ...
    @Override
    public de.lystx.hytoracloud.driver.utils.json.JsonObject<JsonDocument> append(Object value) {
        if (value == null) {
            return this;
        }
    ...
    @Override
    public de.lystx.hytoracloud.driver.utils.json.JsonObject<JsonDocument> def(Object defaultValue) {
    ...
    @Override
    public de.lystx.hytoracloud.driver.utils.json.JsonObject<?> getObject(String key) {
        return de.lystx.hytoracloud.driver.utils.json.JsonObject.gson(this.getGoogleJsonObject(key).toString());
    }
