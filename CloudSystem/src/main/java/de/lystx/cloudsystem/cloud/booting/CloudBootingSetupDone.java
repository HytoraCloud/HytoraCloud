...
public class CloudBootingSetupDone {
    ...
    public CloudBootingSetupDone(CloudSystem cloudSystem) {
        ...
        cloudSystem.cloudServices.add(new CloudNetworkService(cloudSystem, "CloudNetwork", CloudService.CloudServiceType.NETWORK));
        ...
        Cloud.getInstance().setCurrentCloudExecutor(cloudSystem.getService(CloudNetworkService.class).getCloudServer());
