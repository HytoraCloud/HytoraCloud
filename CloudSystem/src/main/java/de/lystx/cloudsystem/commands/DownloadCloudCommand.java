...
public class DownloadCloudCommand extends CloudCommand implements TabCompletable {


    public DownloadCloudCommand(String name, String description, String... aliases) {
