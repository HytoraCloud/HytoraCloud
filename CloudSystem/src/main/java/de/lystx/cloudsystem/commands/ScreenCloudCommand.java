...
public class ScreenCloudCommand extends CloudCommand implements TabCompletable {

    private final CloudScreenPrinter screenPrinter;

    public ScreenCloudCommand(String name, String description, CloudScreenPrinter screenPrinter, String... aliases) {
