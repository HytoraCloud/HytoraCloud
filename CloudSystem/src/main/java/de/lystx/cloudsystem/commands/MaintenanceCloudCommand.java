...
public class MaintenanceCloudCommand extends CloudCommand implements TabCompletable {

    public MaintenanceCloudCommand(String name, String description, String... aliases) {
