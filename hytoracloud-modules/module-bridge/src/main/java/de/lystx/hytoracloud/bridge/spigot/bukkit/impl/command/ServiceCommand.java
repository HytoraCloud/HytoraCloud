            ...
            if (player.hasPermission("cloudsystem.command.service")) {
                if (args.length == 1) {
                    if (args[0].equalsIgnoreCase("info")) {
                        ...
                        player.sendMessage("  §8» §bServer §8┃ §7" + CloudDriver.getInstance().getServiceManager().getThisService().getName());
                        player.sendMessage("  §8» §bState §8┃ §7" + CloudDriver.getInstance().getServiceManager().getThisService().getState().getColor() + CloudDriver.getInstance().getServiceManager().getThisService().getState());
                        player.sendMessage("  §8» §bID §8┃ §7" + CloudDriver.getInstance().getServiceManager().getThisService().getId());
                        ...
                        JsonObject<?> properties = CloudDriver.getInstance().getServiceManager().getThisService().getProperties();
