...
public class NetworkConfig implements Serializable {
    ...
    public NetworkConfig(String host, Integer port, boolean setupDone, ProxyConfig proxyConfig, MessageConfig messageConfig, FallbackConfig fallbackConfig) {
        this.host = host;
        this.port = port;
