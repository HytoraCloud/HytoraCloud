...
import de.lystx.hytoracloud.networking.elements.packet.response.PacketRespond;
...
public abstract class Packet {
    ...
    public void toReply(NetworkConnection connection, Consumer<Component> consumer) {
     ...
     * @return component
     */
    public Component toReply(NetworkConnection connection) {
     ...
     */
    public Component toReply(NetworkConnection connection, int timeOut) {
