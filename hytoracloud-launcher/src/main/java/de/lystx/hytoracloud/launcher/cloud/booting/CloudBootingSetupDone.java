...
public class CloudBootingSetupDone {
    ...
    public CloudBootingSetupDone(CloudSystem cloudSystem) {
        ...
        CloudDriver.getInstance().registerPacketHandler(new PacketHandlerConfig(cloudSystem));
        ...
        CloudDriver.getInstance().registerPacketHandler(new PacketHandlerTPS(cloudSystem));
